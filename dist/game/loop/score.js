...
C.s("_SCOREX", {
  ...
  scoreBoard: function () {
    ...
    C.e("1PScore, WebGL, VUES, Blu").vues({
      x: 0,
      y: wx * 0.75,
      wy: 1,
      w: wx * 4.25,
    ...
    C.e("1PName, DOM, VUES, Tx, Op8, Op").vues({
      x: wx * 0.25,
      y: wx * 0.125,
      wy: 1,
      w: wx * 7,
    ...
    C.e("2PScore, WebGL, VUES, Red").vues({
      x: wx * 13.75,
      y: wx * 0.75,
      wy: 1,
      w: wx * 2.25,
    ...
    C.e("2PName, DOM, VUES, Tx, Op8, Op").vues({
      x: wx * 8.75,
      y: wx * 0.125,
      wy: 1,
      w: wx * 7,
