define(function() {
  ...
  Crafty.s("SET_VUE", {
    ...
    setStats: function() {
      ...
      txt({ a: .5, x: 0, y: 80, w: 100, fF: 2, fS: 2.3, fA: 1, fC: 0, fT: 0 });
      Crafty.e("TXT").text(txtes).
      txt({ a: .5, x: 0, y: 83, w: 100, fF: 2, fS: 2.3, fA: 1, fC: 0, fT: 0 });
    },
    setVue: function() {
      Crafty.e("GetVue");
      Crafty.e("SetVue");
    ...
    setTxt: function() {
      ...
      txt({ a: 1, x: 0, y: 44, w: 100, fF: 0, fS: 5.5, fA: 1, fC: 1, fT: 1 }) //fS:5.5 y:44 h:5.5
      a.attr({ h: a.vuH(5.5) });
      let b = Crafty.e("TXT, _add_sFt").text("SWIPE").
      txt({ a: 1, x: 0, y: 50, w: 100, fF: 1, fS: 11, fA: 1, fC: 1, fT: 1 });
      b.attr({ h: b.vuH(11) });
    ...
    setArrows: function() {
      ...
      txt({ a: 1, x: 0, y: 65, w: 100, fF: 1, fS: 12, fA: 1, fC: 1 });
      a.attr({ h: a.vuH(10) });
      let b = Crafty.e("TXT, _ARROW, _DIR, _N, _DIM").text("^").
      //let b = Crafty.e("TXT, _ARROW, _DIR").text("^").
      txt({ a: 0, x: 0, y: 70, w: 100, fF: 1, fS: 12, fA: 1, fC: 1 });
      b.attr({ h: b.vuH(10) });
      this.setGfx(a);
      this.setGfx(b);
    },
