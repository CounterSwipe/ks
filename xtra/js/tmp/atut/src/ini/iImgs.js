define(function (require) {
  ...
  Crafty.s("SET_IMGS", {
    ...
    getLB: function () {
      ...
      //cards step1: w:192 x h:240
      //step2: canvas size top anchor h:248 (iow + 8px @btm)
      //step3: canvas size center anchor w:256 x h:256       
      imgs.sprites["cards.png"] = {
        tile: 256,
        tileh: 256,
        map: {
          ["CARD_u" + 11 + "m" + 1]: [0, 0],
