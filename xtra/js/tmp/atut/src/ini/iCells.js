  ...
  Crafty.s("SET_CELLS", {
    ...
    cRender: function (wave) {
      ...
      Crafty.e("NuVue, WebGL, Color").
        ...
        color(255, 255, 255, 1).attr({
          alpha: 0.3
        });
      this.render(db[wave]);
      if (wave === 2) {
        this.reRender([720, 820, 920]);
      }
    },
    ...
    render: function (keys) {
      ...
      for (let i = 0, iLen = keys.length; i < iLen; i++) {
        ...
        let x = this.getX(cX);
        if (cKey % 2 && (cKey < 800 && cKey > 600 || cKey > 900) || !(cKey % 2) && (cKey < 900 && cKey > 800) || !(cKey % 2) && (cKey < 600 && cKey > 500) || (cKey % 2) && (cKey < 500)) {
          ac = 0.8;
        } else {
          ac = 1;
        }
