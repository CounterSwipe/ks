define(function(require) {
    ...
    var init = function() {
        ...
        var testModule = function() { return game.modules[12].length() === 5; }; //TODO:change from 5 -> 10 per foeDeck
        //m[12]:mCost => 10 uNumScripts loaded TODO: update if [12] != cost
        onModulesReady(testModule).then(() => {
            game.addSystems([tickM, timer, victory, msg, controllerM, fog, deal, nuFocus, nuPath, egenM, reqmet, captured]);
            //game.addSystems([tick, controllerM, timer, fog, preLaunch, launch, hub, deal, gui|nuFocus, nuPath, eGen, reqmet]);
            ...
            var testDeck = function() { return game.modules[12].length() === 10; }; //TODO:change from 5 -> 10 per foeDeck
            //m[12]:mCost => 10 uNumScripts loaded TODO: update if [12] != cost
            onDeckReady(testDeck).then(() => {
                console.log(game, "gameStart!", game.modules[12].length(), game.modules[12].length() === 10);
