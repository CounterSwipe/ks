...
$profile_help = '<p>' . __('Your profile contains information about you (your &#8220;account&#8221;).') . '</p>' .
//'<p>' . __('Your profile contains information about you (your &#8220;account&#8221;) as well as some personal options related to using WordPress.') . '</p>' .
	...
	'<p>' . __('Your username CANNOT be changed, but you CAN use other fields to enter your real name or a nickname, and change which name to display.') . '</p>' .
	...
	'<p>' . __('Required fields are indicated; the rest are optional.') . '</p>' .
...
get_current_screen()->set_help_sidebar(
    '<p><strong>' . __('For Technical Support DM:') . '</strong></p>' .
    '<p>' . __('<a href="https://twitter.com/CounterSwipe">CounterSwipe Twitter Account</a>') . '</p>' 
